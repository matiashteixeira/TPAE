...
public class Jogo 
{
    ...
    private void criarAmbientes()
    {
        ...
        fora.ajustarSaida("sul", anfiteatro);
        ...
        cantina.ajustarSaida("sul", fora);

        laboratorio.ajustarSaida("norte", fora);
        laboratorio.ajustarSaida("sul", escritorio);
    ...
    private void mensagemDescricao(){
        System.out.println("Voce esta " + ambienteAtual.getDescricao());

        System.out.print("Saidas: ");
        System.out.println(ambienteAtual.getListaSaidas());
        System.out.println();
    }
}
